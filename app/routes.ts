...
export default [
  ...
  route("api/weeks/:weekStart/shopping-list/checks", "routes/api.weeks.$weekStart.shopping-list.checks.tsx"),
  ...
  route("api/shopping-list/:token/checks", "routes/api.shopping-list.$token.checks.tsx"),
