...
export const en: Record<keyof typeof da, string> = {
  ...
  "shoppingList.addItemPlaceholder": "Add an item, e.g. dish soap",
  "shoppingList.addItem": "Add",
  "shoppingList.addItemAdding": "Adding...",
  "shoppingList.removeItem": "Remove",
  "shoppingList.removeItemAria": "Remove {{item}} from the list",
  ...
  "day.suggestModalHeading": "Want a new suggestion?",
  "day.suggestModalBody": "We can find a dish for this day that fits in {{minutes}} min.",
  "day.suggestModalBodyNoLimit": "Want a new suggestion for this day?",
  "day.suggestModalConfirm": "Find a new suggestion",
  "day.suggestModalCancel": "Keep the current dish",
